...
<head>
    ...
    <title>Connexion Gestionnaire - Laboratoire Galaxy-Swiss Bourdin</title>
    ...
    <style>
        * {
        ...
        body {
            ...
            background-image: 
                radial-gradient(#3498db 0.5px, transparent 0.5px), 
                radial-gradient(#3498db 0.5px, #f5f7fa 0.5px);
        ...
        .page-container::before {
            ...
            right: 0;
            bottom: 0;
            background: linear-gradient(135deg, rgba(52, 152, 219, 0.1) 0%, rgba(245, 247, 250, 0.9) 100%);
            z-index: -1;
        }
    ...
    <div class="page-container">
        <div class="login-container">
            <div class="logo-container">
                ...
                <span class="user-type-badge">Espace Gestionnaire</span>
            ...
            <form method="post" action="{{ url('/gestionnaire') }}" id="loginForm">
                {{ csrf_field() }}
            ...
            <div class="user-type-selector">
                <a href="{{ url('/') }}" class="user-type-link">
                    <i class="fas fa-exchange-alt"></i> Accéder à l'espace visiteur médical
                </a>
            </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            inputs.forEach(input => {
                input.addEventListener('focus', function() {
                    this.parentElement.parentElement.querySelector('label').style.color = '#3498db';
                });
